...
; medium
level_m2:         ; grass--water--grass--water--grass
...
; medium (tree maze)
level_m4:         ; grass--water--grass--water--grass--water--grass
    ; columns
...
; medium (turtles)
level_m5:         ; grass--water--grass (turtles)
...
; hard (turtles)
level_h1:        ; grass--water--grass (turtles)
